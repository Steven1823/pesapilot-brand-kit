  ...
  "rounded-xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        safe: "bg-card border-l-4 border-l-success border-border",
        warning: "bg-card border-l-4 border-l-warning border-border",
        danger: "bg-card border-l-4 border-l-destructive border-border",
        interactive: "bg-card border-border hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
